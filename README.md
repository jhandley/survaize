...
Survaize is a tool that automatically converts "paper" questionnaires into interactive survey apps. It uses a combination of OCR and generative AI vision models to understand the structure of survey questionnaires in order to generate survey apps compatible with data collection platforms like [CSPro](https://www.census.gov/data/software/cspro.html), [Open Data Kit](https://getodk.org) and [Survey Solutions](https://mysurvey.solutions/).
...
## ODK Export
The ODK export generates an [xlsform](https://xlsform.org) file that can be used with ODK Collect or other ODK-compatible tools. The xlsform will include the questionnaire structure and question text.
